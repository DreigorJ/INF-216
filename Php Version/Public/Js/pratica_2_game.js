...
const somMove = new Audio("/Midia/Pratica_2/chute.ogg");
const somPancada = new Audio("/Midia/Pratica_2/pancada.ogg");
const somAh = new Audio("/Midia/Pratica_2/ah.ogg");
...
var fundo =  new function(){
    this.img = new Image();
    this.img.src = '/Midia/Pratica_2/fundonoite.png';  
...
var lutador =  new function(){
    this.agente = new Personagem('/Midia/Pratica_2/lutador.gif', 230,120, 132,125 );
    this.frames = 6;
    this.corrente=0;
...
var lutadora =  new function(){
    this.agente = new Personagem('/Midia/Pratica_2/lutadora.png', 500,150, 95,80 );
    this.frames = 5;
    this.corrente=0;
    this.estados= new Array();
