...
var fundo =  new function(){
    this.img = new Image();
    this.img.src = '/Midia/Pratica_4/fundo.png';  
    this.sx=200;
...
var heroi =  new function(){
    let that = this;
    this.agente = new Personagem('/Midia/Pratica_4/heroi.png', 500,45, 95,50 );
    this.corrente = 0;
...
function acertaJanela(){
    ...
    } else if (heroi.agente.x-fundo.sx>350){
        fundo.sx = heroi.agente.x-350; 
    }
}
