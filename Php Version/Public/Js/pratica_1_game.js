...
var fundo =  new function(){
    this.img = new Image();
    this.img.src = '/Midia/Pratica_1/rochas.png';  
}

var explosao =  new function(){
    this.img = new Image();
    this.img.src = '/Midia/Pratica_1/explosion.png';
    this.width = 50;
    this.height = 50;
}
...
var formiga = new function(){
    ...
    this.image.src = "/Midia/Pratica_1/ant.png"
    this.width = 25;
    this.height = 25;
    this.frames = 1;
    this.actualFrame = 0;
...
var t =  new function(){
    ...
    this.img = new Image();
    this.img.src = '/Midia/Pratica_1/turtle.png';  
...
function desenhaExplosao(){
    ctx.drawImage(explosao.img,0,0,explosao.width,explosao.height,t.x,t.y,explosao.width,explosao.height);  
}
...
document.onkeypress = function(e){
    ...
    if (testaColisao()) {
        // alert("Voce bateu! Reinicie a pagina"); 
         return;
    }
